...
def plot_marker_exp(adata, markers, var_group_col, group_col = None, group_categ_col = None,
    ...
    if var_group_col is not None: 
        adata_sss.obs[var_group_col] = adata_sss.obs[var_group_col].astype(str)
    if group_categ_col is not None: 
        adata_sss.obs[group_categ_col] = adata_sss.obs[group_categ_col].astype(str)
    if group_col is not None: 
        adata_sss.obs[group_col] = adata_sss.obs[group_col].astype(str)
